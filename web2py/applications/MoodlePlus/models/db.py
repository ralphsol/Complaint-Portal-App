...
db.define_table(
    ...
    Field('type_','integer', default=0), # 0 for student, 1 for professor
...
db.define_table(
    'complaints',
    Field('user_id', db.users),
    Field('type_', 'integer'), # 0 for individual, 1 for hostel level, 2 for insti
    Field('title','string'),
    Field('description', 'string'),
    Field('resolved', 'boolean'),
    Field('resolver', 'integer'),
    Field('upvote', 'integer', default=0),
    Field('downvote', 'integer', default=0),
    Field('assignedto', 'integer', default=3), #id assigned to
...
db.define_table( # Foreign key constraint key failed
    'compresc',
    #Field('complaint_id', db.complaints),
    Field('user_id',db.users),
    Field('name','string'),
